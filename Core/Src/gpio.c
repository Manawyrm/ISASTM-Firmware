...
const struct iopin iopins[] = {
	/* Debug LEDs */ 
	{ GPIOG, GPIO_PIN_9, GPIO_MODE_OUTPUT_PP, 0 }, // LED1
	{ GPIOG, GPIO_PIN_10, GPIO_MODE_OUTPUT_PP, GPIO_FLAG_DEFAULT_ACTIVE },// LED2
	{ GPIOG, GPIO_PIN_11, GPIO_MODE_OUTPUT_PP, GPIO_FLAG_DEFAULT_ACTIVE },// LED3
	{ GPIOG, GPIO_PIN_12, GPIO_MODE_OUTPUT_PP, GPIO_FLAG_DEFAULT_ACTIVE },// LED4
	{ GPIOG, GPIO_PIN_13, GPIO_MODE_OUTPUT_PP, GPIO_FLAG_DEFAULT_ACTIVE },// LED5
	...
	{ GPIOF, GPIO_PIN_6, GPIO_MODE_OUTPUT_PP,  0 },// IRQ_DIR
	{ GPIOH, GPIO_PIN_13, GPIO_MODE_OUTPUT_PP, GPIO_FLAG_ACTIVE_LOW },// ~IRQ_OE
